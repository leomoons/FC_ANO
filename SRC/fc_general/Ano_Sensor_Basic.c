...
//��Ҫ�������õ��ⲿ������
#define X_POS_OFFSET_CM    (0)//(Ano_Parame.set.center_pos_cm[X]); //X������ƫ�ƴ洢ֵ
#define Y_POS_OFFSET_CM    (0)//(Ano_Parame.set.center_pos_cm[Y]); //Y������ƫ�ƴ洢ֵ
#define Z_POS_OFFSET_CM    (0)//(Ano_Parame.set.center_pos_cm[Z]); //Z������ƫ�ƴ洢ֵ
...
//======================================================================
	...
	/*ת����λ*/
		...
		{
			/*������ת������ÿ�룬����+-2000��*/
			sensor.Gyro_deg[i] = sensor.Gyro[i] *0.061036f ;//  /65535 * 4000; +-2000�� 0.061
