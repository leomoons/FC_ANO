...
const float fast_atan_table_lyh[257] = 
{
...
float fast_atan2_lyh(float y, float x) 
{
	...
	else 
	{
		...
		else 
		{
			...
			base_angle = fast_atan_table_lyh[index];
			base_angle += (fast_atan_table_lyh[index + 1] - fast_atan_table_lyh[index]) * alpha;
		}
